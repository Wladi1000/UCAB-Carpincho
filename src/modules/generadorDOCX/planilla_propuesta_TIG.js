...
const generarNombresAlumno = () => {
    ...
    let alumno2 = null;
    let alumno1 = null;
    console.log(planilla_propuesta_TIG.alumno[0] !== null);
    console.log(planilla_propuesta_TIG.alumno[1] !== null);
   if (planilla_propuesta_TIG.alumno[0] !== null){
            ...
            new docx.TableCell({
                ...
                children: [
                    new docx.Paragraph({
                        ...
                        children: [
                            new docx.TextRun({
                                text: planilla_propuesta_TIG.alumno[0].nombre,
                            })
                        ],
                    })
                ],
   ...
   if (planilla_propuesta_TIG.alumno[1] !== null){
            ...
            new docx.TableCell({
                ...
                children: [
                    new docx.Paragraph({
                        ...
                        children: [
                            new docx.TextRun({
                                text: planilla_propuesta_TIG.alumno[1].nombre,
                            })
                        ],
                    })
                ],
...
const generarTablaDatosEmpresa = (object) => {
            let empresa = {...object};
            let tablaEmpresa = [];
        ...
        sections: [{
            ...
            children: [
                ...
                new docx.Paragraph({
                    ...
                    children: [
                        new docx.TextRun({
                            text: "Por medio de la presente hago constar que estoy dispuesto a supervisar, en calidad de Tutor Académico el Trabajo Experimental de Grado (TEG) titulado: " + '"'+planilla_propuesta_TIG.titulo+'", que será desarrollado por el (los) alumno(s):',
                            font: "Times New Roman",
                        })
                    ],
                    alignment: docx.AlignmentType.JUSTIFIED,
                ...
                generarDatosAlumnos(planilla_propuesta_TIG.alumno)[0],
                generarDatosAlumnos(planilla_propuesta_TIG.alumno)[1],
                new docx.Paragraph({
                    style: "aside",
                    children: [
                        new docx.TextRun({
                                ...
                                new docx.TableCell({
                                    ...
                                    children: [
                                        new docx.Paragraph({
                                            ...
                                            children: [
                                                new docx.TextRun({
                                                    text: planilla_propuesta_TIG.tutor_empresarial.fecha_entrega.toString(),
                                                })
                                            ],
                                        })
                                    ],
                ...
                new docx.Table({
                    rows: generarTablaDatosEmpresa(planilla_propuesta_TIG.empresa)
                }),
                new docx.Paragraph({
                    style: "aside",
                    children:[ 

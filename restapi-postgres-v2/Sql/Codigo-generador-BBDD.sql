...
--Planilla de evaluaciòn de revisor de propuesta de trabajo de grado instrumental
...
--PLANILLAS DE EVALUACION DE JURADO
...
--PLANILLAS DE EVALUACION FINAL PARA TRABAJO DE GRADO
...
----------------------------------------------
---CRITERIOS DE REVISOR DE TRABAJO DE GRADO---
----------------------------------------------
...
----------------------------------------------------------------
---RELACION ENTRE PLANILLAS DE REVISOR Y CRITERIOS DE REVISOR---
----------------------------------------------------------------
...
----------------------------------------------------------------------------
---RELACIONES ENTRE LA PLANILLA DE EVALUACION FINAL Y PLANILLAS DE JURADO---
----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS Contiene_PE_J_TDGE (
	id_PE_Final_TDGE INTEGER NOT NULL,
	id_PE_J_TDGE INTEGER NOT NULL,
	PRIMARY KEY (id_PE_final_TDGE,id_PE_J_TDGE),
	FOREIGN KEY (id_PE_final_TDGE) REFERENCES PE_Final_TDGE(id_PE_Final_TDGE)
		ON UPDATE RESTRICT
		ON DELETE RESTRICT,

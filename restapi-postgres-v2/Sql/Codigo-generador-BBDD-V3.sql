...
CREATE TABLE IF NOT EXISTS PTG (
	id_PTG SERIAL NOT NULL,
	fecha_entrega DATE DEFAULT NULL,
	estatus CHAR(2) NOT NULL DEFAULT 'PC',
	id_SPTG INTEGER NOT NULL,
	id_profesor_revisor INTEGER DEFAULT NULL,
	fecha_designacion_revisor DATE DEFAULT NULL,
	PRIMARY KEY (id_PTG),
	FOREIGN KEY (id_SPTG) REFERENCES SPTG(id_SPTG)
		ON UPDATE RESTRICT 
		ON DELETE CASCADE,
	FOREIGN KEY (id_profesor_revisor) REFERENCES Profesores(id_profesor)
		ON UPDATE RESTRICT 
